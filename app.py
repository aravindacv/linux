...
<style>
    /* ============================================================
       ...
       Streamlit's native widgets (selectbox dropdown, chat_input,
       alerts, tooltips) are rendered in portals OUTSIDE .stApp and
       pull their colors from these CSS custom properties, not from
       the classes below. If the user's Streamlit theme is set to
       "Dark", those portals stay dark/unreadable no matter what we
       do to .stApp. Overriding the variables at :root fixes them
       everywhere at once, regardless of light/dark theme setting.
       ============================================================ */
    :root, html, body {
        --background-color: #e0e5ec !important;
        --secondary-background-color: #e0e5ec !important;
        --text-color: #2d3436 !important;
        --primary-color: #74b9ff !important;
    ...
    /* Open dropdown menu / options list (rendered in a portal, easy to miss).
       These render inside a <div data-baseweb="popover"> appended to <body>,
       so they must be forced regardless of the active Streamlit theme. */
    ...
    /* Chat input box (Practice Terminal input) — force light bg + dark text
       regardless of dark theme, and cover its placeholder text too */
    ...
    [data-testid="stChatInput"] * { color: #2d3436 !important; }
    [data-testid="stChatInputSubmitButton"] {
        background-color: #74b9ff !important;
    }

    /* "Working Directory:" caption line above the terminal */
    .term-container div[style] { color: #2d3436 !important; }
</style>
"""
